...
export const mockCollections: CollectionDefinition[] = [
  {
    ...
    description:
      "Reference chunks for product, delivery, and platform design material.",
    scope: "project-42",
    status: "Healthy",
    latencyMs: 64,
    dimensions: 1536,
  ...
  },
  {
    ...
    description:
      "Customer-facing incident and escalation summaries prepared for retrieval.",
    scope: "support-ops",
    status: "Degraded",
    latencyMs: 112,
    dimensions: 3072,
